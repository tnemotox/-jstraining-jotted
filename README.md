...
WebベースでJavaScript/CSS/HTMLを一問一答形式で学習するための基盤です。
[Jotted](https://ghinda.net/jotted/)というOSSを元に作成しています。
...
* 不要なファイルであっても、空ファイルで作成しておいてください
* list.jsonに問題の種別を増やしたい場合は、main.jsを編集する必要があります（すぐできるので必要であればご相談ください）
